...
with app.app_context():
    ...
    bill_1 = Bill(user_id = user_1.id, total = 14.99, tip = 5.00, created_at = datetime.now().date())  
    ...
    bill_5 = Bill(user_id = user_2.id, total = 14.99, tip = 8.00, created_at = datetime.now().date())   

    bill_6 = Bill(user_id = user_3.id, total = 14.99, tip = 3.00, created_at = datetime.now().date())   

    bill_7 = Bill(user_id = user_3.id, total = 21.00, tip = 5.50, created_at = datetime.now().date())   

    bill_8 = Bill(user_id = user_3.id, total = 12.00, tip = 1.50, created_at = datetime.now().date())   

    bill_9 = Bill(user_id = user_4.id, total = 29.98, tip = 4.50, created_at = datetime.now().date())   

    bill_10 = Bill(user_id = user_4.id, total = 10.50, tip = 7.00, created_at = datetime.now().date())  
